...
const VMS_Page = () => {
    ...
    return (
        <>
            <Head>
                <title>Visitor Management System VMS  - Insead Technology</title>
            </Head>
                        ...
                        <div className="mt-65 mb-100">
                            <div className="row align-items-end">
                                <div className="col-lg-6 mb-20">
                                    <span className="title-line color-brand-2">Provide a greater level of security</span>
                                    <h2 className="color-brand-2 mt-10">Visitor Management System VMS</h2>
                                </div>
                                <div className="col-lg-6 mb-20">
                                    <p className="font-md color-grey-50">The Visitor Management System VMS is a feature-rich suite of components that facilitate the tracking and monitoring of individuals within a complex or building. By automating the processes of registering, tracking and out-processing, the manual overheads of performing such tasks are reduced significantly. Manual paperwork is also minimized with comprehensive electronic data export and sharing. Provides emergency-related features.</p>
                                </div>
                            </div>
                                ...
                                <div className="box-inner-video-banner">
                                    <div className="row align-items-start">
                                        <div className="col-lg-5">
                                            <p className="color-grey-500 font-lg"> VMS The Visitor Management System VMS is a feature-rich suite of components that facilitate the tracking and monitoring of individuals within a complex or building. By automating the processes of registering, tracking and out-processing, the manual overheads of performing such tasks are reduced significantly. Manual paperwork is also minimized with comprehensive electronic data export and sharing.</p>
                                        </div>
