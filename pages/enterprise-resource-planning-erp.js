...
const ERP_Page = () => {
    ...
    return (
        <>
            <Head>
                <title>Enterprise Resource Planning ERP - Insead Technology</title>
            </Head>
                        ...
                        <div className="mt-65 mb-100">
                            <div className="row align-items-end">
                                <div className="col-lg-6 mb-20">
                                    <span className="title-line color-brand-2">We ensure your best ERP solution</span>
                                    <h2 className="color-brand-2 mt-10">Enterprise Resource Planning ERP</h2>
                                </div>
                                <div className="col-lg-6 mb-20">
                                    <p className="font-md color-grey-50">Our Enterprise Resource Planning implementation depends on consorting with a trusted and Competent Software Provider. We ensure your best ERP implementation will allow your organization to achieve business goals through updated Business procedures supported by the appropriate Technology.</p>
                                </div>
                            </div>
                                ...
                                <div className="box-inner-video-banner">
                                    <div className="row align-items-start">
                                        <div className="col-lg-5">
                                            <p className="color-grey-500 font-lg">We provide a complete range of services to support your ERP implementation requirements.
                                              </p>
                                        </div>
                                ...
                                <div className="col-lg-6 col-md-12">
                                    <div className="card-offer card-we-do card-marketing hover-up">
                                        ...
                                        <div className="card-info">
                                            ...
                                            <p className="font-md color-grey-500 mb-5">This feature enables all the inventory management related to your business. Item, Sales, Customer, Purchase and Interaction transfers. </p>
                                ...
                                <div className="col-lg-6 col-md-12">
                                    <div className="card-offer card-we-do card-marketing hover-up">
                                        ...
                                        <div className="card-info">
                                            ...
                                            <p className="font-md color-grey-500 mb-5">This module includes Standard BOM's, Purchase cost and extra import duties, Production cost, Project task and jobs, Profit and loss and multiple profit and loss. </p>
                                            <div className="box-button-offer">
                                                <Link className="btn btn-default font-sm-bold pl-0 color-brand-1" href="contact">
                                                    Learn More
                                                    <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="col-lg-6 col-md-12">
                                    <div className="card-offer card-we-do card-marketing hover-up">
                                        ...
                                        <div className="card-info">
                                            ...
                                            <p className="font-md color-grey-500 mb-5">Basic account management like Chart of Account, Receivables, Payable, General Ledger and Trial balance all these features covered in this module</p>
                                            <div className="box-button-offer">
                                                <Link className="btn btn-default font-sm-bold pl-0 color-brand-1" href="contact">
                                                    Learn More
                                                    <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="col-lg-6 col-md-12">
                                    <div className="card-offer card-we-do card-marketing hover-up">
                                        ...
                                        <div className="card-info">
                                            ...
                                            <p className="font-md color-grey-500 mb-5">This Module gives the reports of Inventory, Sales, Purchase, Production, Inter-location Transfer and General Ledger. </p>
                                            <div className="box-button-offer">
                                                <Link className="btn btn-default font-sm-bold pl-0 color-brand-1" href="contact">
                                                    Learn More
                                                    <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="col-lg-6 col-md-12">
                                    <div className="card-offer card-we-do card-marketing hover-up">
                                        ...
                                        <div className="card-info">
                                            ...
                                            <p className="font-md color-grey-500 mb-5">TUser can Create and host reports in application, any customization and adhoc reports are also covered in this module. </p>
                                            <div className="box-button-offer">
                                                <Link className="btn btn-default font-sm-bold pl-0 color-brand-1" href="contact">
                                                    Learn More
                                                    <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="col-lg-6 col-md-12">
                                    <div className="card-offer card-we-do card-marketing hover-up">
                                        ...
                                        <div className="card-info">
                                            <h4 className="color-brand-1 mb-10">
                                                <Link className="color-brand-1" href="job-detail">
                                                Web BI And Dashboard
                                                </Link>
                                            </h4>
                                            <p className="font-md color-grey-500 mb-5">Graphs reports of sales, purchase, cash, top payable, top receivable, top selling item and branches, Dead stock and Profit branch wise. </p>
                                            <div className="box-button-offer">
                                                <Link className="btn btn-default font-sm-bold pl-0 color-brand-1" href="contact">
                                                    Learn More
                                                    <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="col-lg-6 col-md-12">
                                    <div className="card-offer card-we-do card-marketing hover-up">
                                        ...
                                        <div className="card-info">
                                            ...
                                            <p className="font-md color-grey-500 mb-5">Pursue scalable customer service through sustainable potentialities. </p>
                                            <div className="box-button-offer">
                                                <Link className="btn btn-default font-sm-bold pl-0 color-brand-1" href="contact">
                                                    Learn More
                                                    <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="col-lg-6 col-md-12">
                                    <div className="card-offer card-we-do card-marketing hover-up">
                                        ...
                                        <div className="card-info">
                                            ...
                                            <p className="font-md color-grey-500 mb-5">Appropriately empower dynamic leadership skills after business portals.  </p>
                                            <div className="box-button-offer">
                                                <Link className="btn btn-default font-sm-bold pl-0 color-brand-1" href="contact">
                                                    Learn More
                                                    <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="box-container">
                            <div className="row mb-0 mt-40 project-revert align-items-center">
                                <div className="col-xl-5 col-lg-6 col-md-6 mt-30">
                                    <span className="btn btn-tag">ERP Processes</span>
                                    <h2 className="color-brand-1 mt-10 mb-15">A brief process of ERP System</h2>
                                    <ul className="list-core-value list-core-value-white">
                                        <li><span className="ticked" />
                                        Inventory Management will manage all your inventory.
                                        </li>
                                        <li><span className="ticked" />
                                        Cost management will all cost-related issues.
                                        </li>
                                        
                                        <li><span className="ticked" />
                                        General Ledger manager will manage all your ledger.
                                        </li>
                                        
                                        <li><span className="ticked" />
                                        Standard Reports will cover all the details in reports form.
                                        </li>
                                        
                                        <li><span className="ticked" />
                                        Dynamic Reports will cover customization reports.
                                        </li>
                                        
                                        <li>
                                        <span className="ticked" />
                                        WEB BI and Dashboard includes every detail in form of graphs.
                                        </li>
