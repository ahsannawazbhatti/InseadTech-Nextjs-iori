        ...
        <>
            <Layout>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-xl-8 col-lg-10 m-auto">
                                    <div className="text-center"> <span className="font-md color-grey-400">Think. Creative. Solve</span>
                                        <h1 className="color-brand-1 mb-25 mt-10">Innovative Solution to Move Your Business Forward</h1>
                                        <p className="font-md color-grey-500 mb-25">Collaborate, plan projects and manage resources with powerful features that your whole team<br className="d-none d-lg-block" />can use.  The latest news, tips and advice to help you run your business with less fuss.</p>
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-6 mb-30">
                                <div className="box-our-app"><span className="title-line line-48">Why using our app</span>
                                    <h3 className="color-brand-1 mb-20 mt-15">Our app is great for individuals, startups and enterprises. It have never been easier to manage your finances</h3>
                                    <p className="font-sm color-grey-500 mb-40">Eos eveniet nesciunt et accusamus suscipit est magnam consequatur aut quisquam perferendis a reprehenderit quis aut voluptatem repellat est beatae reiciendis? Cum omnis corrupti cum incidunt veritatis vel libero provident aut reiciendis animi ut quod quaerat et velit animi et omnis illo. Sit quae harum eos incidunt sequi eum iste fugit ex omnis aliquam a explicabo quam.</p>
                                    <div className="box-item-comment">
                                        ...
                                        <div className="info-comment">
                                            <p className="font-lg-bold color-grey-500 comment-quote mb-15">Et corporis quia est iusto delectus ea consequuntur sapiente in quia totam ut internos architecto. Eos deleniti dolore eos enim totam et eaque nisi.</p><span className="font-md-bold color-brand-1">Albert Flores</span>
                            ...
                            <div className="col-lg-6"><span className="title-line line-48">Why using our app</span>
                                ...
                                <div className="row">
                                    <div className="col-lg-9">
                                        <p className="font-sm color-grey-500">Eos eveniet nesciunt et accusamus suscipit est magnam consequatur aut quisquam perferendis a reprehenderit quis aut voluptatem repellat est beatae reiciendis? Cum omnis corrupti cum incidunt veritatis vel libero provident aut reiciendis animi ut quod quaerat et velit animi et omnis illo. Sit quae harum eos incidunt sequi eum iste fugit ex omnis aliquam a explicabo quam.</p>
                                    </div>
                                </div>
                                <div className="mt-35">
                                    <div className="row">
                ...
                <section className="section mt-90">
                    <div className="container">
                        <div className="text-center">
                            <h2 className="color-brand-1 mb-20">Everything will become One</h2>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12 text-center">
                                <h2 className="color-brand-1 mb-20">Why You Should Consider Installing</h2>
                ...
                <section className="section mt-50 mb-40 box-testimonial-2 bg-grey-60 pt-120 pb-120">
                    <div className="container">
                        <div className="row align-items-center">
