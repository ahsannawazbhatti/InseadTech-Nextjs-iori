                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-3 width-20">
                                <div className="mb-2"><img src="assets/imgs/template/logo-37.png" alt="iori" /></div>
                            ...
                            <div className="col-lg-3 width-23">
                                ...
                                <h5 className="mb-10 color-brand-1">Follow Us</h5>
                    ...
                    <div className="container">
                        <div className="footer-bottom">
                            <div className="row">
                                ...
                                <div className="col-lg-6 col-md-12 text-center text-lg-end"><span className="color-grey-300 font-md">©Insead Tech 2023. All right reversed.</span></div>
                            </div>
                        </div>
                    </div>
                </div>
